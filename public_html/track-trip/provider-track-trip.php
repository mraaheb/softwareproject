...
<head>
    ...
    <title>Adud — Provider Track Trip</title>
    ...
    <link rel="stylesheet" href="provider-track-trip.css">
</head>
<body>
...
<aside class="sidebar">
    ...
    <div class="nav-section">
        ...
        <a class="nav-item active" href="../track-trip/provider-track-trip.php<?php echo $request_id ? '?id=' . urlencode((string)$request_id) : ''; ?>">
            <span class="icon">📍</span>
            <div class="nav-item-content">
...
<main class="main">
    <div class="topbar">
        <div>
            <h1>Trip Details / تفاصيل الرحلة</h1>
            <p>View patient trip information and current workflow status</p>
        </div>

        <button class="back-btn" onclick="location.href='../provider-dashboard/provider-dashboard.php'">
            ← Back / رجوع
        </button>
    </div>
    ...
    <?php if (!$request): ?>
        <div class="info-card">
            <div class="card-body">
                <p>No provider trip found / لا توجد رحلة للمزود</p>
            </div>
        </div>
    <?php else: ?>
        ...
        <section>
            <div class="info-card">
                <div class="card-header">
                    <h2>Trip Information / معلومات الرحلة</h2>
                    <p>Assigned transport trip details</p>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="detail-row">
                        ...
                        <div class="detail-info">
                            <div class="label">Patient / المريض</div>
                            <div class="value"><?php echo htmlspecialchars($request["patient_name"] ?: "—"); ?></div>
                        </div>
                    </div>
                    ...
                    <div class="detail-row">
                        <div class="detail-icon">🏥</div>
                        <div class="detail-info">
                            <div class="label">Guardian / المرافق</div>
                            <div class="value"><?php echo !empty($request["escort_name"]) ? htmlspecialchars($request["escort_name"]) : "None"; ?></div>
                        </div>
                    </div>
                    ...
                    <div class="actions-section">
                      ...
                      <div class="action-buttons">
                        <?php if (in_array($current_status, ['Assigned'], true)): ?>
                            <button onclick="goUpdate('Picked Up')">Picked Up</button>
                        <?php endif; ?>

                        <?php if (in_array($current_status, ['Assigned', 'Picked Up'], true)): ?>
                            <button onclick="goUpdate('Arrived')">Arrived</button>
                        <?php endif; ?>

                        <?php if (in_array($current_status, ['Arrived'], true)): ?>
                            <button onclick="goUpdate('Completed')">Complete</button>
                        <?php endif; ?>

                        <?php if (in_array($current_status, ['Assigned', 'Picked Up', 'Arrived'], true)): ?>
                            <button class="danger" onclick="goUpdate('Cancelled')">Cancel</button>
                        <?php endif; ?>
                      </div>
                    </div>
                    ...
                    ?>
                        <div class="timeline-item">
                            ...
                            <div class="tl-content">
                                ...
                                <div class="tl-sub"><?php echo htmlspecialchars($item ? getStatusNoteFallback($status) : getStatusNoteFallback($status)); ?></div>
...
<form id="updateForm" method="POST" action="../provider-dashboard/provider-dashboard.php" style="display:none;">
